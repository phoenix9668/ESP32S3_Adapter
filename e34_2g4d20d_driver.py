...
class E34_2G4D20D_Class:
    """ E34-2G4D20D class, incloud configure function"""

    def __init__(self, addh=0x00, addl=0x00, alise="E34-2G4D20D"):
        ...
        self.dev_speed = {'baudrate_9600': 0x18, 'baudrate_57600': 0x30}
        self.dev_model = ['Half_Duplex_Mode','Full_Duplex_Mode','Reserve_Mode','Set_Mode']
        pass
    
    def model_sel(self, mode='Half_Duplex_Mode'):
    ...
    def config_reg(self, baudrate=9600, addh=0x00, addl=0x00, chan=0x00, mode='Half_Duplex_Mode'):
